...
public class MultiGraph {
	...
	/**
	 * print the edges between two nodes
	 * 
	 * @param src source node
	 * @param dst destination node
	 */
	public void pritSpectrum(int src, int dst) {
		for (int i = 0; i < edgesRemoved[src][dst].length; i++) {
			if (!edgesRemoved[src][dst][i]) {
				System.out.print("0  ");
			} else {
				System.out.print("1  ");
			}
